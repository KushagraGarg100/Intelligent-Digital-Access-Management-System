      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <Card className="p-4 lg:col-span-2">
          ...
          <div className="grid gap-3 md:grid-cols-4">
            <div>
              <div className="mb-1 text-xs text-slate-400">Filename</div>
      ...
      >
        {!selected ? (
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card className="p-4">
              <div className="mb-4 flex aspect-video items-center justify-center overflow-hidden rounded-md bg-slate-900 border border-slate-800">
                {selected.asset_type === "image" ? (
                  <img
                    src={selected.storage_url || `${import.meta.env.VITE_API_BASE_URL || "http://localhost:8080/api"}/assets/${selected.id}/download`}
                  ...
                  <div className="flex flex-col items-center gap-2 text-slate-500">
                    ...
                    <span className="text-xs uppercase tracking-wider">{selected.content_type}</span>
                  </div>
                )}
              </div>
              ...
              <div className="mt-3 space-y-2 text-sm text-slate-300">
                ...
                <div>
                  ...
                  <span className="text-slate-100 uppercase text-xs font-semibold">{selected.asset_type}</span>
                </div>
                <div>
